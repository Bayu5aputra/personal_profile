...
const KeyData = () => {
  ...
  const handleDeleteKey = async (keyData) => {
    if (window.confirm(`Are you sure you want to delete key: ${keyData.key}?`)) {
              ...
              <div className="keydata-header-content">
                <div className="keydata-header-left">
                  ...
                  <p className="keydata-subtitle">
                    Generate and manage review authentication keys
                  </p>
                </div>
              ...
              <table className="keydata-table">
                ...
                <tbody>
                  {keys.length === 0 ? (
                    ...
                    keys.map((keyData) => (
                      <tr key={keyData.id} className={keyData.used ? 'key-used key-protected' : 'key-available'}>
                        <td>
